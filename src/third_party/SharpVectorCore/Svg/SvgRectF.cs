    ...
    public struct SvgRectF : IEquatable<SvgRectF>
    {
        ...
        public bool IsEmpty
        {
            get {
                if (_width > 0f)
                {
                    return NumOperations.LesserOrEquals(_height, 0f);
                }
        ...
        {
            if ((NumOperations.LesserOrEquals(_x, x) && (x < (_x + _width))) && NumOperations.LesserOrEquals(_y, y))
            {
                return (y < (_y + _height));
            }
        ...
        {
            if ((NumOperations.LesserOrEquals(_x, rect.X) && NumOperations.LesserOrEquals(rect.X + rect.Width, _x + _width)) 
                && NumOperations.LesserOrEquals(_y, rect.Y))
            {
                return NumOperations.LesserOrEquals(rect.Y + rect.Height, _y + _height);
            }
        ...
        public static SvgRectF Intersection(SvgRectF a, SvgRectF b)
        {
            ...
            if (NumOperations.GreaterOrEquals(dRight, dLeft) && NumOperations.GreaterOrEquals(dBottom, dTop))
            {
