...
namespace SharpVectors.Renderers.Texts
{
    public sealed class WpfGlyphTextBuilder : WpfTextBuilder
    {
        ...
        public WpfGlyphTextBuilder(FontFamily fontFamily, FontStyle fontStyle, FontWeight fontWeight,
            ...
            : base(culture, (fontFamily ?? WpfDrawingSettings.DefaultFontFamily).Source, fontSize, null)
        {
            _typeface = new Typeface(fontFamily ?? WpfDrawingSettings.DefaultFontFamily, fontStyle, fontWeight,
...
//                    isRightToLeft = true;
        ...
        {
            if (index < 0 || clusterMap == null || index >= clusterMap.Length)
                throw new ArgumentException();
