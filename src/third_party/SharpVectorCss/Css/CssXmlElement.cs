...
namespace SharpVectors.Dom.Css
{
    ...
    public class CssXmlElement : Element, IElementCssInlineStyle
    {
        ...
        protected void FireParentNodeChange(object src, XmlNodeChangedEventArgs args, bool fireEvent)
        {
            if (fireEvent)
            {
                parentNodeChangeHandler?.Invoke(src, args);
            }
        ...
        protected void FireChildNodeChange(object src, XmlNodeChangedEventArgs args, bool fireEvent)
        {
            if (fireEvent)
            {
                childNodeChangeHandler?.Invoke(src, args);
            }
        ...
        public event NodeChangeHandler attributeChangeHandler;
        public event NodeChangeHandler elementChangeHandler;
        public event NodeChangeHandler parentNodeChangeHandler;
        public event NodeChangeHandler childNodeChangeHandler;
        public event CssChangeHandler cssChangeHandler;
