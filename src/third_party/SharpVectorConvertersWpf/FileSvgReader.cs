...
namespace SharpVectors.Converters
{
    ...
    public sealed class FileSvgReader : SvgConverter
    {
        ...
        private DrawingGroup LoadFile(string fileName)
        {
            ...
            var svgDocument = (SvgDocument)_wpfWindow.Document;
        ...
        private bool SaveFile(string fileName)
        {
            ...
            if (this.SaveZaml)
            {
                ...
                using (FileStream zamlSourceFile = new FileStream(xamlFileName,
                    FileMode.Open, FileAccess.Read, FileShare.Read))
                {
                    ...
                    {
                        using (var zipStream = new GZipStream(zamlDestFile, CompressionMode.Compress, true))
                        {
