...
//            this.UnloadDiagrams();
        ...
        private DrawingGroup CreateMessageText(string messageText)
        {
            ...
            if ((fillBrush == null && strokeBrush == null) || NumOperations.LesserOrEquals(opacity, 0)
                || fontFamily == null || NumOperations.LesserOrEquals(fontSize, 3))
            {
                return null;
            }
            if (strokeBrush == null)
        ...
        {
            SvgControl canvas = (SvgControl)d;
