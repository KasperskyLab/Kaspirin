...
namespace SharpVectors.Dom.Svg
{
    ...
    public class SvgElement : CssXmlElement, ISvgElement
    {
        ...
        public float GetAttribute(string name, float defValue)
        {
            ...
            {
                float value;
                if (float.TryParse(this.GetAttribute(name), NumberStyles.Float, NumberFormatInfo.InvariantInfo, out value))
                {
                    return value;
                }
            }
        ...
        public int GetAttribute(string name, int defValue)
        {
            ...
            {
                int value;
                if (int.TryParse(this.GetAttribute(name), NumberStyles.Number, NumberFormatInfo.InvariantInfo, out value))
                {
                    return value;
                }
            }
        ...
        public double GetAttribute(string name, double defValue)
        {
            ...
            {
                double value;
                if (double.TryParse(this.GetAttribute(name), NumberStyles.Float, NumberFormatInfo.InvariantInfo, out value))
                {
                    return value;
                }
            }
        ...
        public long GetAttribute(string name, long defValue)
        {
            ...
            {
                long value;
                if (long.TryParse(this.GetAttribute(name), NumberStyles.Number, NumberFormatInfo.InvariantInfo, out value))
                {
                    return value;
                }
            }
