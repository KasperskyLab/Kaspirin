...
<xsl:transform xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
	...
	<xsl:template match="TextAreas">
		...
		<xsl:if test="$shouldProcess = 'true'">
			<xsl:call-template name="getRegionComment">
				<xsl:with-param name="description">TextAreas</xsl:with-param>
			</xsl:call-template>
	...
	<xsl:template match="TextArea">
		...
		<xsl:element name="Style">
			<xsl:attribute name="TargetType">{x:Type visuals:TextArea}</xsl:attribute>
			...
			<xsl:element name ="Style.Resources">
				...
				<xsl:call-template name="generateStyle">
					...
					<xsl:with-param name="key">CounterStyle</xsl:with-param>
					<xsl:with-param name="setters">
						<!--TextElement.Foreground-->
						<xsl:call-template name="generateSetterViaAttribute">
							<xsl:with-param name="propertyName">TextElement.Foreground</xsl:with-param>
							<xsl:with-param name="propertyValue">
								<xsl:call-template name="generateResExtension">
									<xsl:with-param name="key">CounterForeground</xsl:with-param>
									<xsl:with-param name="scope" select="$id"/>
								</xsl:call-template>
							</xsl:with-param>
						</xsl:call-template>
				...
				<xsl:call-template name="generateStyle">
					<xsl:with-param name="targetType">TextBlock</xsl:with-param>
					<xsl:with-param name="basedOn" select="@CounterStyleId"/>
					<xsl:with-param name="key">CounterFullStyle</xsl:with-param>
					<xsl:with-param name="setters">
						<!--TextElement.Foreground-->
						<xsl:call-template name="generateSetterViaAttribute">
							<xsl:with-param name="propertyName">TextElement.Foreground</xsl:with-param>
							<xsl:with-param name="propertyValue">
								<xsl:call-template name="generateResExtension">
									<xsl:with-param name="key">CounterForegroundFull</xsl:with-param>
									<xsl:with-param name="scope" select="$id"/>
								</xsl:call-template>
							</xsl:with-param>
						</xsl:call-template>
			...
			<!--TextInput_CounterStyle-->
			<xsl:call-template name="generateStaticResourceSetter">
				<xsl:with-param name="propertyId">TextInput_CounterStyle</xsl:with-param>
				<xsl:with-param name="resourceName">CounterStyle</xsl:with-param>
			</xsl:call-template>

			<!--TextInput_Counter_Margin-->
			<xsl:call-template name="generateMarginSetter">
				<xsl:with-param name="propertyId">TextInput_Counter_Margin</xsl:with-param>
			...
			<xsl:element name="Style.Triggers">
				...
				<!--[Counter Full data trigger]-->
				<xsl:call-template name="generateDataTrigger">

					<xsl:with-param name="binding">
						<xsl:call-template name="generateCompactMultiBinding">
							
							<xsl:with-param name="binding1">
								<xsl:call-template name="generateBinding">
									<xsl:with-param name="propertyName">Text.Length</xsl:with-param>
							...
							<xsl:with-param name="binding2">
								<xsl:call-template name="generateBinding">
									<xsl:with-param name="propertyName">MaxLength</xsl:with-param>
									<xsl:with-param name="relativeSource">
										<xsl:call-template name="generateRelativeSource"/>
									</xsl:with-param>
								</xsl:call-template>
							...
							<xsl:with-param name="converter">{visuals:MultiValueEqualityToBooleanConverter}</xsl:with-param>
					...
					<xsl:with-param name="setters">
						...
						<!--TextInput_CounterFullStyle-->
						<xsl:call-template name="generateStaticResourceSetter">
							<xsl:with-param name="propertyId">TextInput_CounterStyle</xsl:with-param>
							<xsl:with-param name="resourceName">CounterFullStyle</xsl:with-param>
						</xsl:call-template>
