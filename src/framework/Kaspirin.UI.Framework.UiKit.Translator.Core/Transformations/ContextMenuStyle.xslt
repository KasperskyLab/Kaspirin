...
<xsl:transform xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
	...
	<xsl:template match="ContextMenus">
		...
		<xsl:if test="$shouldProcess = 'true'">
			<xsl:call-template name="getRegionComment">
				<xsl:with-param name="description">ContextMenus</xsl:with-param>
			</xsl:call-template>
	...
	<xsl:template match="ContextMenu">
		...
		<xsl:call-template name="generateStyle">
			<xsl:with-param name="targetType">visuals:ContextMenu</xsl:with-param>
			<xsl:with-param name="basedOn">ContextMenuUniversal</xsl:with-param>
			...
			<xsl:with-param name="setters">
				...
				<!--ContextMenu_PopupDecoratorStyle-->
				<xsl:call-template name="generateStaticResourceSetter">
					<xsl:with-param name="propertyId">ContextMenu_PopupDecoratorStyle</xsl:with-param>
