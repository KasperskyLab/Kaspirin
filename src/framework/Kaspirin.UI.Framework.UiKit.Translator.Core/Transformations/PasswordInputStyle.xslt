...
<xsl:transform xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
	...
	<xsl:template match="PasswordInputs">
		...
		<xsl:if test="$shouldProcess = 'true'">
			<xsl:call-template name="getRegionComment">
				<xsl:with-param name="description">PasswordInputs</xsl:with-param>
			</xsl:call-template>
	...
	<xsl:template match="PasswordInput">
		...
		<xsl:element name="Style">
			<xsl:attribute name="TargetType">{x:Type visuals:PasswordInput}</xsl:attribute>
			<xsl:attribute name="BasedOn">{StaticResource PasswordInputUniversal}</xsl:attribute>
			...
			<!--PasswordInput_ActionBar_Margin-->
			<xsl:call-template name="generateMarginSetter">
				<xsl:with-param name="propertyId">PasswordInput_ActionBar_Margin</xsl:with-param>
				<xsl:with-param name="marginNode" select="ActionBarMargin" />
			</xsl:call-template>

			<!--PasswordInput_Background-->
			<xsl:call-template name="generateBrushSetter">
				<xsl:with-param name="propertyId">PasswordInput_Background</xsl:with-param>
				<xsl:with-param name="brushName">BackgroundNormal</xsl:with-param>
				<xsl:with-param name="scopeName" select="$id" />
			</xsl:call-template>

			<!--PasswordInput_BorderBrush-->
			<xsl:call-template name="generateBrushSetter">
				<xsl:with-param name="propertyId">PasswordInput_BorderBrush</xsl:with-param>
			...
			<xsl:call-template name="generateThicknessSetter">
				<xsl:with-param name="propertyId">PasswordInput_BorderThickness</xsl:with-param>
				<xsl:with-param name="thicknessNode" select="BorderThicknessNormal" />
			</xsl:call-template>

			<!--PasswordInput_CaretBrush-->
			<xsl:call-template name="generateBrushSetter">
				<xsl:with-param name="propertyId">PasswordInput_CaretBrush</xsl:with-param>
				<xsl:with-param name="brushName">CaretBrush</xsl:with-param>
				<xsl:with-param name="scopeName" select="$id" />
			</xsl:call-template>

			<!--PasswordInput_CornerRadius-->
			<xsl:call-template name="generateCornerRadiusSetter">
				<xsl:with-param name="propertyId">PasswordInput_CornerRadius</xsl:with-param>
			</xsl:call-template>

			<!--PasswordInput_Height-->
			<xsl:call-template name="generateHeightSetter">
				<xsl:with-param name="propertyId">PasswordInput_Height</xsl:with-param>
			</xsl:call-template>

			<!--PasswordInput_Padding-->
			<xsl:call-template name="generatePaddingSetter">
				<xsl:with-param name="propertyId">PasswordInput_Padding</xsl:with-param>
			</xsl:call-template>

			<!--PasswordInput_Placeholder_Foreground-->
			<xsl:call-template name="generateBrushSetter">
				<xsl:with-param name="propertyId">PasswordInput_Placeholder_Foreground</xsl:with-param>
				<xsl:with-param name="brushName">PlaceholderForeground</xsl:with-param>
				<xsl:with-param name="scopeName" select="$id" />
			</xsl:call-template>

			<!--PasswordInput_PlaceholderStyle-->
			<xsl:call-template name="generateStaticResourceSetter">
				<xsl:with-param name="propertyId">PasswordInput_PlaceholderStyle</xsl:with-param>
				<xsl:with-param name="resourceName" select="@TextRegularStyleId" />
			</xsl:call-template>

			<!--PasswordInput_CaptionStyle-->
			<xsl:call-template name="generateStaticResourceSetter">
				<xsl:with-param name="propertyId">PasswordInput_CaptionStyle</xsl:with-param>
				<xsl:with-param name="resourceName">CaptionStyle</xsl:with-param>
			</xsl:call-template>

			<!--PasswordInput_Caption_Margin-->
			<xsl:call-template name="generateMarginSetter">
				<xsl:with-param name="propertyId">PasswordInput_Caption_Margin</xsl:with-param>
				<xsl:with-param name="marginNode" select="CaptionMargin" />
			</xsl:call-template>

			<!--PasswordInput_LabelStyle-->
			<xsl:call-template name="generateStaticResourceSetter">
				<xsl:with-param name="propertyId">PasswordInput_LabelStyle</xsl:with-param>
				<xsl:with-param name="resourceName">LabelStyle</xsl:with-param>
			</xsl:call-template>

			<!--PasswordInput_Label_Margin-->
			<xsl:call-template name="generateMarginSetter">
				<xsl:with-param name="propertyId">PasswordInput_Label_Margin</xsl:with-param>
				<xsl:with-param name="marginNode" select="LabelMargin" />
			</xsl:call-template>

			<!--PasswordInput_TextForeground-->
			<xsl:call-template name="generateBrushSetter">
				<xsl:with-param name="propertyId">PasswordInput_TextForeground</xsl:with-param>
				<xsl:with-param name="brushName">TextForeground</xsl:with-param>
				<xsl:with-param name="scopeName" select="$id" />
			</xsl:call-template>

			<!--PasswordInput_ValidationPopupStyle-->
			<xsl:call-template name="generateStaticResourceSetter">
				<xsl:with-param name="propertyId">PasswordInput_ValidationPopupStyle</xsl:with-param>
			...
			<xsl:element name="Style.Triggers">
				...
				<xsl:call-template name="generateTrigger">
					...
					<xsl:with-param name="setters">
						...
						<!--PasswordInput_TextStyle-->
						<xsl:call-template name="generateStaticResourceSetter">
							<xsl:with-param name="propertyId">PasswordInput_TextStyle</xsl:with-param>
							<xsl:with-param name="resourceName" select="@TextRegularStyleId" />
						</xsl:call-template>
