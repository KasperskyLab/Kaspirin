...
<xsl:transform xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
	...
	<xsl:template match="InteractivityNotifications/InteractivityNotification">
		...
		<xsl:if test="$shouldProcess = 'true'">
			<xsl:element name="CustomizationDictionary">
				...
				<ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
					...
					<xsl:call-template name="generateBrush">
						<xsl:with-param name="key">CloseButtonForeground</xsl:with-param>
						<xsl:with-param name="brushNode" select="CloseButtonForeground"/>
					</xsl:call-template>
