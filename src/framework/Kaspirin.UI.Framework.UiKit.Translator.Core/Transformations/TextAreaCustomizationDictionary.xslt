...
<xsl:transform xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
	...
	<xsl:template match="TextAreas/TextArea">
		...
		<xsl:if test="$shouldProcess = 'true'">
			<xsl:element name="CustomizationDictionary">
				...
				<ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
					...
					<!--BackgroundReadOnly-->
					<xsl:call-template name="generateBrush">
						<xsl:with-param name="key">BackgroundReadOnly</xsl:with-param>
						<xsl:with-param name="brushNode" select="BackgroundReadOnly"/>
					</xsl:call-template>
					...
					<!--BorderColorReadOnly-->
					<xsl:call-template name="generateBrush">
						<xsl:with-param name="key">BorderColorReadOnly</xsl:with-param>
						<xsl:with-param name="brushNode" select="BorderColorReadOnly"/>
					</xsl:call-template>
					...
					<xsl:call-template name="generateBrush">
						...
						<xsl:with-param name="brushNode" select="CounterForeground"/>
					</xsl:call-template>

					<!--CounterForegroundFull-->
					<xsl:call-template name="generateBrush">
						<xsl:with-param name="key">CounterForegroundFull</xsl:with-param>
						<xsl:with-param name="brushNode" select="CounterForegroundFull"/>
					</xsl:call-template>
