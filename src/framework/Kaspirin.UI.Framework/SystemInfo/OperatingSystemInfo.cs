...
public static class OperatingSystemInfo
{
    ...
    /// <summary>
    ///     Specifies whether the operating system is Windows 10 RS3 or later.
    /// </summary>
    public static bool IsWin10Rs3OrHigher { get; private set; }
    ...
    /// <summary>
    ///     Indicates whether the current operating system is Windows 11 24H2 or later.
    /// </summary>
    public static bool IsWin11Version24H2OrHigher { get; private set; }
    ...
    private static bool CheckIsWindowsServer16()
    {
        ...
        return _versionInfo.Value.MajorVersion == 10
            ...
            && _versionInfo.Value.ProductType != OsProductType.Workstation;
    }
    ...
    private static bool CheckIsWindowsServer()
    {
        ...
        return _versionInfo.Value.ProductType != OsProductType.Workstation;
    }
    ...
    private static bool CheckIsWindowsMultiSession()
    {
        ...
        versionInfo.ProductType = OsProductType.Server;
        var typeMask = OsVersionInfoTypeFlags.ProductType;
        var conditionMask = Kernel32Dll.VerSetConditionMask(0, typeMask, OsVersionInfoConditionMask.Equal);
    ...
    private static OsVersionInfo? GetOsVersionInfo()
    {
        ...
        {
            osInfo.ProductType = OsProductType.Workstation;
        }
    ...
    private static void InitializeProperties()
    {
        ...
        IsWin10Rs3OrHigher = Environment.OSVersion.IsWin10Rs3OrHigher();
        ...
        IsWin11Version24H2OrHigher = Environment.OSVersion.IsWin11Version24H2OrHigher();
    }
