...
public sealed class RapidUnityContainer : IUnityContainer
{
    ...
    public IUnityContainer RegisterInstance<T>(T instance) where T : notnull
        => RegisterInstance(typeof(T), instance, LifetimeType.Singleton);

    /// <inheritdoc cref="IUnityContainer.RegisterInstance{T}(T, LifetimeType)"/>
    public IUnityContainer RegisterInstance<T>(T instance, LifetimeType lifetimeType) where T : notnull
        => RegisterInstance(typeof(T), instance, lifetimeType);
    ...
    public IUnityContainer RegisterInstance(Type type, object instance)
        => RegisterInstance(type, instance, LifetimeType.Singleton);
    ...
    public IUnityContainer RegisterInstance(Type type, object instance, string name)
        => RegisterInstance(type, instance, name, LifetimeType.Singleton);

    /// <inheritdoc cref="IUnityContainer.RegisterInstance(Type, object, LifetimeType)"/>
    public IUnityContainer RegisterInstance(Type type, object instance, LifetimeType lifetimeType)
        => RegisterInstance(type, instance, Default.String, lifetimeType);

    /// <inheritdoc cref="IUnityContainer.RegisterInstance(Type, object, string, LifetimeType)"/>
    public IUnityContainer RegisterInstance(Type type, object instance, string name, LifetimeType lifetimeType)
    {
        Guard.ArgumentIsNotNull(type);
        Guard.ArgumentIsNotNull(instance);
        Guard.ArgumentIsNotNull(name);
        Guard.ArgumentIsNotNull(lifetimeType);

        return RegisterDependencyBag(new DependencyKey(type, name), CreateInstanceDependencyBag(instance, lifetimeType));
    }

    /// <inheritdoc cref="IUnityContainer.RegisterType{T}()"/>
    public IUnityContainer RegisterType<T>()
        => RegisterType(typeof(T), LifetimeType.Transient, Default.String, Default.InjectionMemberArray);
    ...
    public IUnityContainer RegisterType<T>(params InjectionMember[] injectionMembers)
        => RegisterType(typeof(T), LifetimeType.Transient, Default.String, injectionMembers);

    /// <inheritdoc cref="IUnityContainer.RegisterType{T}(LifetimeType)"/>
    public IUnityContainer RegisterType<T>(LifetimeType lifetimeType)
        => RegisterType(typeof(T), lifetimeType, Default.String, Default.InjectionMemberArray);

    /// <inheritdoc cref="IUnityContainer.RegisterType{T}(LifetimeType, InjectionMember[])"/>
    public IUnityContainer RegisterType<T>(LifetimeType lifetimeType, params InjectionMember[] injectionMembers)
        => RegisterType(typeof(T), lifetimeType, Default.String, injectionMembers);

    /// <inheritdoc cref="IUnityContainer.RegisterType{T}(LifetimeType, string, InjectionMember[])"/>
    public IUnityContainer RegisterType<T>(LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers)
        => RegisterType(typeof(T), lifetimeType, name, injectionMembers);

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type)"/>
    public IUnityContainer RegisterType(Type type)
        => RegisterType(type, LifetimeType.Transient, Default.String, Default.InjectionMemberArray);
    ...
    public IUnityContainer RegisterType(Type type, params InjectionMember[] injectionMembers)
        => RegisterType(type, LifetimeType.Transient, Default.String, injectionMembers);

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type, LifetimeType)"/>
    public IUnityContainer RegisterType(Type type, LifetimeType lifetimeType)
        => RegisterType(type, lifetimeType, Default.String, Default.InjectionMemberArray);

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type, LifetimeType, InjectionMember[])"/>
    public IUnityContainer RegisterType(Type type, LifetimeType lifetimeType, params InjectionMember[] injectionMembers)
        => RegisterType(type, lifetimeType, Default.String, injectionMembers);

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type, LifetimeType, string, InjectionMember[])"/>
    public IUnityContainer RegisterType(Type type, LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers)
    {
        Guard.ArgumentIsNotNull(type);
        Guard.ArgumentIsNotNull(name);
        Guard.ArgumentIsNotNull(lifetimeType);
        ...
        return RegisterDependencyBag(new DependencyKey(type, name), CreateDependencyBag(type, lifetimeType, injectionMembers));
    }
    ...
    public IUnityContainer RegisterType<TFrom, TTo>() where TTo : TFrom
    {
        ...
        RegisterType(typeof(TTo), LifetimeType.Transient, Default.String, Default.InjectionMemberArray);
    ...
    /// <inheritdoc cref="IUnityContainer.RegisterType{TFrom, TTo}(LifetimeType)"/>
    public IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType) where TTo : TFrom
    {
        if (IsOverriddenInterface<TFrom>())
        {
            return this;
        ...
        RegisterType(typeof(TTo), lifetimeType, Default.String, Default.InjectionMemberArray);
        return MapInterface(typeof(TFrom), typeof(TTo), Default.String);
    }

    /// <inheritdoc cref="IUnityContainer.RegisterType{TFrom, TTo}(LifetimeType, InjectionMember[])"/>
    public IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType, params InjectionMember[] injectionMembers) where TTo : TFrom
    {
        if (IsOverriddenInterface<TFrom>())
        {
            return this;
        ...
        RegisterType(typeof(TTo), lifetimeType, Default.String, injectionMembers);
        return MapInterface(typeof(TFrom), typeof(TTo), Default.String);
    }

    /// <inheritdoc cref="IUnityContainer.RegisterType{TFrom, TTo}(LifetimeType, string, InjectionMember[])"/>
    public IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers) where TTo : TFrom
    {
        if (IsOverriddenInterface<TFrom>())
        {
            return this;
        ...
        RegisterType(typeof(TTo), lifetimeType, name, injectionMembers);
        return MapInterface(typeof(TFrom), typeof(TTo), name);
    }

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type, Type, LifetimeType, InjectionMember[])"/>
    public IUnityContainer RegisterType(Type typeFrom, Type typeTo, LifetimeType lifetimeType, params InjectionMember[] injectionMembers)
    {
        RegisterType(typeTo, lifetimeType, Default.String, injectionMembers);
        return MapInterface(typeFrom, typeTo, Default.String);
    }

    /// <inheritdoc cref="IUnityContainer.RegisterType(Type, Type, LifetimeType, string, InjectionMember[])"/>
    public IUnityContainer RegisterType(Type typeFrom, Type typeTo, LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers)
    {
        RegisterType(typeTo, lifetimeType, name, injectionMembers);
    ...
    public IUnityContainer OverrideType<TFrom, TTo>() where TTo : TFrom
        => OverrideType<TFrom, TTo>(LifetimeType.Transient);

    /// <inheritdoc cref="IUnityContainer.OverrideType{TFrom, TTo}(LifetimeType)"/>
    public IUnityContainer OverrideType<TFrom, TTo>(LifetimeType lifetimeType) where TTo : TFrom
    {
        ...
        RegisterType<TFrom, TTo>(lifetimeType);
        _overrides.Add(type);
        return this;
    }
    ...
    public object Resolve(Type type, string name, params ResolverOverride[] resolverOverrides)
    {
        ...
        try
        {
            ...
            if (!_dependencyBags.TryGetValue(dependencyKey, out var dependencyBag))
            {
                ...
                {
                    dependencyBag = CreateDependencyBag(type, LifetimeType.Transient, Default.InjectionMemberArray);
                    AddDependencyBag(dependencyKey, dependencyBag);
                }
                else
                {
    ...
    private IDependencyBag MakeFunctionFactoryDependencyBag(Type type, string name)
    {
        ...
        return CreateInstanceDependencyBag(func, LifetimeType.Singleton);
    }
    ...
    private IDependencyBag MakeLazyFactoryDependencyBag(Type type, string name)
    {
        ...
        {
            var dependencyBag = CreateInstanceDependencyBag(factory, LifetimeType.Singleton);
            AddDependencyBag(factoryDependencyKey, dependencyBag);
        }

        return CreateDependencyBag(type, LifetimeType.Transient, new InjectionConstructor(new ResolvedParameter(factoryType, name)));
    }
    ...
    private IDependencyBag MakeParametrizedFactoryDependencyBag(Type factoryType, string name)
    {
        ...
        return CreateInstanceDependencyBag(factory, LifetimeType.Singleton);
    }
    ...
    private IDependencyBag MakeGenericTypeDependencyBag(Type type, OpenGenericTypeDependencyBag dependencyBag)
    {
        ...
        return CreateDependencyBag(implementationType, dependencyBag.LifetimeType, dependencyBag.InjectionMembers);
    }
    ...
    private IDependencyBag CreateInstanceDependencyBag(object instance, LifetimeType lifetimeType)
    {
        return lifetimeType switch
        {
            LifetimeType.Singleton => new ContainerControlledInstanceDependencyBag(instance),
            LifetimeType.WeakSingleton => new ExternallyControlledInstanceDependencyBag(instance),
            _ => throw new UnexpectedValueException(lifetimeType)
        };
    }

    private IDependencyBag CreateDependencyBag(Type type, LifetimeType lifetimeType, params InjectionMember[] injectionMembers)
    {
        if (IsOpenGenericType(type))
        {
            return new OpenGenericTypeDependencyBag(type, lifetimeType, injectionMembers);
        }

        return lifetimeType switch
        {
            LifetimeType.Singleton => new ContainerControlledDependencyBag(CreateValueFactory(type, injectionMembers)),
            LifetimeType.WeakSingleton => new ExternallyControlledDependencyBag(CreateValueFactory(type, injectionMembers)),
            LifetimeType.Transient => new TransientDependencyBag(CreateValueFactory(type, injectionMembers)),
            _ => throw new UnexpectedValueException(lifetimeType)
        };
    }
    ...
    {
        public OpenGenericTypeDependencyBag(Type type, LifetimeType lifetimeType, InjectionMember[] injectionMembers)
        {
            Type = type;
