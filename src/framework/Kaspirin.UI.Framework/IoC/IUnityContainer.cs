...
public interface IUnityContainer : IDisposable
{
    ...
    ///     The type of the instance lifecycle.
    /// </param>
    /// <returns>
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterInstance<T>(T instance, LifetimeType lifetimeType) where T : notnull;
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterInstance(Type type, object instance, LifetimeType lifetimeType);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterInstance(Type type, object instance, string name, LifetimeType lifetimeType);
    ...
    /// </typeparam>
    /// <param name="lifetimeType">
    ///     The type of lifecycle of the instance being created.
    /// </param>
    /// <returns>
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<T>(LifetimeType lifetimeType);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<T>(LifetimeType lifetimeType, params InjectionMember[] injectionMembers);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<T>(LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType(Type type, LifetimeType lifetimeType);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType(Type type, LifetimeType lifetimeType, params InjectionMember[] injectionMembers);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType(Type type, LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType) where TTo : TFrom;
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType, params InjectionMember[] injectionMembers) where TTo : TFrom;
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType<TFrom, TTo>(LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers) where TTo : TFrom;
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType(Type typeFrom, Type typeTo, LifetimeType lifetimeType, params InjectionMember[] injectionMembers);
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer RegisterType(Type typeFrom, Type typeTo, LifetimeType lifetimeType, string name, params InjectionMember[] injectionMembers);
    ...
    ///     been registered in the container, then this method works as <see cref="RegisterType{TFrom, TTo}(LifetimeType)" />.
    /// </remarks>
    /// <typeparam name="TFrom">
    ///     The registered source type.
    /// </typeparam>
    ...
    ///     The current instance is <see cref="IUnityContainer" />.
    /// </returns>
    IUnityContainer OverrideType<TFrom, TTo>(LifetimeType lifetimeType) where TTo : TFrom;
