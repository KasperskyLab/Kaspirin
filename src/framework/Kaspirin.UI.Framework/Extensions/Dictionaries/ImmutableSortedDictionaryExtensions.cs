...
{
    /// <summary>
    ///     Extension methods for <see cref="ImmutableSortedDictionary{TKey,TValue}" />.
    /// </summary>
    public static class ImmutableSortedDictionaryExtensions
    {
        ...
        /// </returns>
        public static ImmutableSortedDictionary<TKey, TValue?> UpdateItem<TKey, TValue>(
            this ImmutableSortedDictionary<TKey, TValue?> dictionary,
            TKey key,
            Func<TValue?, TValue?> modifier)
            where TKey : notnull
            => (ImmutableSortedDictionary<TKey, TValue?>)ImmutableDictionaryModifier.UpdateItem(dictionary, key, modifier);
        ...
        ///     A copy of the dictionary <paramref name="dictionary" /> with changes.
        /// </returns>
        public static ImmutableSortedDictionary<TKey, TValue?> UpdateItems<TKey, TValue>(
            this ImmutableSortedDictionary<TKey, TValue?> dictionary,
            Func<TValue?, TValue?> modifier)
            where TKey : notnull
        ...
        public static ImmutableSortedDictionary<TKey, TValue?> UpdateItems<TKey, TValue>(
            ...
            where TKey : notnull
            => (ImmutableSortedDictionary<TKey, TValue?>)ImmutableDictionaryModifier.UpdateItems(dictionary, modifier);
        ...
        ///     A copy of the dictionary <paramref name="dictionary" /> with changes.
        /// </returns>
        public static ImmutableSortedDictionary<TKey, TValue?> AddOrUpdate<TKey, TValue>(
            this ImmutableSortedDictionary<TKey, TValue?> dictionary,
            TKey key,
            Func<TValue?, TValue?> modifier)
            where TKey : notnull
        ...
        public static ImmutableSortedDictionary<TKey, TValue?> AddOrUpdate<TKey, TValue>(
            ...
            Func<TValue?, TValue?> modifier)
            where TKey : notnull
            => (ImmutableSortedDictionary<TKey, TValue?>)ImmutableDictionaryModifier.AddOrUpdate(dictionary, key, defaultValueFactory, modifier);
    }
}
