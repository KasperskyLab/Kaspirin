...
{
    /// <summary>
    ///     An interpolated string handler to check that the GUID is not empty.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct AssertIfNotEmptyGuidInterpolatedStringHandler
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfNotEmptyGuidInterpolatedStringHandler" /> class.
        /// </summary>
        ...
        /// </param>
        public AssertIfNotEmptyGuidInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            Guid guid,
            out bool isEnabled)
