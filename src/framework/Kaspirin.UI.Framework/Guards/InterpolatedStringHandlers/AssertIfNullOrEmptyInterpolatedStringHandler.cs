...
{
    /// <summary>
    ///     An interpolated string handler to check that the string is empty or equal to <see langword="null" />.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct AssertIfNullOrEmptyInterpolatedStringHandler
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfNullOrEmptyInterpolatedStringHandler" /> class.
        /// </summary>
        ...
        /// </param>
        public AssertIfNullOrEmptyInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            string? str,
            out bool isEnabled)
        {
            isEnabled = string.IsNullOrEmpty(str);
