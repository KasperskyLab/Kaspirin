...
{
    /// <summary>
    ///     An interpolated string handler to verify that the object is not of type <typeparamref name="T" />.
    /// </summary>
    /// <typeparam name="T">
    ///     The type of object to check.
    /// </typeparam>
    [InterpolatedStringHandler]
    public ref struct AssertIfNotInstanceOfTypeInterpolatedStringHandler<T>
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfNotInstanceOfTypeInterpolatedStringHandler{T}" /> class.
        /// </summary>
        ...
        /// </param>
        /// <param name="obj">
        ///     An object to check if it is an instance of type <typeparamref name="T" />.
        /// </param>
        /// <param name="isEnabled">
        ///     Indicates whether the handler is enabled.
        /// </param>
        public AssertIfNotInstanceOfTypeInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            object? obj,
            out bool isEnabled)
        {
            isEnabled = obj is not T;
