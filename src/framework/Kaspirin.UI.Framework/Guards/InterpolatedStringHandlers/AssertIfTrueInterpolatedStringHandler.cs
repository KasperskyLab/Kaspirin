...
{
    /// <summary>
    ///     An interpolated string handler to verify that the condition is true.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct AssertIfTrueInterpolatedStringHandler
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfTrueInterpolatedStringHandler" /> class.
        /// </summary>
        ...
        /// </param>
        public AssertIfTrueInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            bool condition,
            out bool isEnabled)
