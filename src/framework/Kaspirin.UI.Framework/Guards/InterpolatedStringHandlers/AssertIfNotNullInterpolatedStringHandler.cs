...
{
    /// <summary>
    ///     An interpolated string handler to check that the object is not <see langword="null" />.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct AssertIfNotNullInterpolatedStringHandler
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfNotNullInterpolatedStringHandler" /> class.
        /// </summary>
        ...
        /// </param>
        public AssertIfNotNullInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            object? obj,
            out bool isEnabled)
        {
            isEnabled = obj is not null;
