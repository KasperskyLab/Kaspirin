...
{
    /// <summary>
    ///     An interpolated string handler to check that the condition is false.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct AssertIfFalseInterpolatedStringHandler
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AssertIfFalseInterpolatedStringHandler" /> structure.
        /// </summary>
        ...
        /// </param>
        public AssertIfFalseInterpolatedStringHandler(
            int literalLength,
            int formattedCount,
            bool condition,
            out bool isEnabled)
