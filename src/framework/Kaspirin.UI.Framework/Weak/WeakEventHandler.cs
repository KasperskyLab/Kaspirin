...
public static class WeakEventHandler
{
    ...
    ///     <br /> The weak link of the event is checked every time the event is called, and if the weak
    ///     link is deleted, then the <paramref name="cleanup" /> delegate is called in this case.
    /// </remarks>
    /// <returns>
