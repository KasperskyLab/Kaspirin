...
/// <summary>
///     Handler for an interpolated string with error messages.
/// </summary>
[InterpolatedStringHandler]
public ref struct ErrorInterpolatedStringHandler
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="ErrorInterpolatedStringHandler" /> structure.
    /// </summary>
    ...
    public ErrorInterpolatedStringHandler(
        ...
        out bool isEnabled)
    {
        _isEnabled = isEnabled = ComponentTracer.CanTraceError;
