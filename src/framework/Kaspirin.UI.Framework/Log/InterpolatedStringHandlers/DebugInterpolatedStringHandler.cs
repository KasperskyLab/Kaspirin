...
/// <summary>
///     An interpolated string handler with debugging messages.
/// </summary>
[InterpolatedStringHandler]
public ref struct DebugInterpolatedStringHandler
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="DebugInterpolatedStringHandler" /> structure.
    /// </summary>
    ...
    public DebugInterpolatedStringHandler(
        ...
        out bool isEnabled)
    {
        _isEnabled = isEnabled = ComponentTracer.CanTraceDebug;
