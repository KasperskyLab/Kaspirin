...
/// <summary>
///     An interpolated string handler with warning messages.
/// </summary>
[InterpolatedStringHandler]
public ref struct WarnInterpolatedStringHandler
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="WarnInterpolatedStringHandler" /> structure.
    /// </summary>
    ...
    /// </param>
    public WarnInterpolatedStringHandler(
        int literalLength,
        int formattedCount,
        out bool isEnabled)
    {
        _isEnabled = isEnabled = ComponentTracer.CanTraceWarn;
