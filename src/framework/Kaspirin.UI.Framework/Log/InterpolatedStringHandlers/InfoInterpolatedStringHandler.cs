...
namespace Kaspirin.UI.Framework.Log.InterpolatedStringHandlers;

/// <summary>
///     An interpolated string handler with information messages.
/// </summary>
[InterpolatedStringHandler]
public ref struct InfoInterpolatedStringHandler
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="InfoInterpolatedStringHandler" /> structure.
    /// </summary>
    ...
    /// </param>
    public InfoInterpolatedStringHandler(
        int literalLength,
        int formattedCount,
        out bool isEnabled)
    {
        _isEnabled = isEnabled = ComponentTracer.CanTraceInfo;
