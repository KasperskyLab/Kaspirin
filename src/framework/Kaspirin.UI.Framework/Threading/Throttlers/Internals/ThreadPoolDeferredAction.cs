...
internal sealed class ThreadPoolDeferredAction : IDeferredAction
{
    public ThreadPoolDeferredAction(DeferredActionParameters parameters, IThreadPoolExecutor executor)
        => _deferredAction = new ThreadPoolDeferredAction<object>(parameters, executor);
    ...
    private readonly ThreadPoolDeferredAction<object> _deferredAction;
}
