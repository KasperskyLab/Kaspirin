...
[TestClass]
public sealed class MultiBooleanToVisibilityInverseConverterTests
{
    [TestMethod]
    public void Convert_AllFalseValues_AndOperation_ReturnsVisible()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_AllFalseValues_OrOperation_ReturnsVisible()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { false, false, false };
        var targetType = typeof(Visibility);
        var parameter = default(object);
        var culture = CultureInfo.InvariantCulture;
    ...
    [TestMethod]
    public void Convert_AllTrueValues_AndOperation_ReturnsCollapsed()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_AllTrueValues_OrOperation_ReturnsCollapsed()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { true, true, true };
    ...
    [TestMethod]
    public void Convert_EmptyValues_AndOperation_ReturnsCollapsed()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_EmptyValues_OrOperation_ReturnsVisible()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.Or };
        var values = Array.Empty<object>();
    ...
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter();
    ...
    [TestMethod]
    public void Convert_MixedBooleanValues_AndOperation_ReturnsVisible()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_MixedBooleanValues_OrOperation_ReturnsCollapsed()
    {
        // Arrange
        var converter = new MultiBooleanToVisibilityInverseConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { true, false, true };
