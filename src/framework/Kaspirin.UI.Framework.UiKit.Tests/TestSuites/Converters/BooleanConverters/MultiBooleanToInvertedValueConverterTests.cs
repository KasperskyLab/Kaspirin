...
[TestClass]
public sealed class MultiBooleanToInvertedValueConverterTests
{
    [TestMethod]
    public void Convert_AllFalseValues_AndOperation_ReturnsTrue()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_AllFalseValues_OrOperation_ReturnsTrue()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { false, false, false };
        var targetType = typeof(bool);
        var parameter = default(object);
        var culture = CultureInfo.InvariantCulture;
    ...
    [TestMethod]
    public void Convert_AllTrueValues_AndOperation_ReturnsFalse()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_AllTrueValues_OrOperation_ReturnsFalse()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { true, true, true };
    ...
    [TestMethod]
    public void Convert_EmptyValues_AndOperation_ReturnsFalse()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_EmptyValues_OrOperation_ReturnsTrue()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.Or };
        var values = Array.Empty<object>();
    ...
    [TestMethod]
    public void Convert_MixedBooleanValues_AndOperation_ReturnsTrue()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.And };
    ...
    [TestMethod]
    public void Convert_MixedBooleanValues_OrOperation_ReturnsFalse()
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter { Operation = MultiBooleanOperation.Or };
        var values = new object?[] { true, false, true };
    ...
    {
        // Arrange
        var converter = new MultiBooleanToInvertedValueConverter();
