...
public static class UIKitPaletteStorage
{
    ...
    private static IDictionary<UIKitPalette, string> PaletteMapping { get; } = new Dictionary<UIKitPalette, string>
    {
        ...
        { UIKitPalette.ControlsBGEmeraldSubtleDefaultFocusLoading, "ControlsBG_Emerald-Subtle-Default-Focus-Loading" },
        { UIKitPalette.ControlsBGEmeraldSubtleHover, "ControlsBG_Emerald-Subtle-Hover" },
        { UIKitPalette.ControlsBGEmeraldSubtlePressed, "ControlsBG_Emerald-Subtle-Pressed" },
        ...
        { UIKitPalette.StatusHighSubtle, "Status_High-Subtle" },
        { UIKitPalette.StatusHighSubtleTransparent20, "Status_High-Subtle-Transparent_20" },
        { UIKitPalette.StatusInfo, "Status_Info" },
        { UIKitPalette.StatusInfoSubtle, "Status_Info-Subtle" },
        { UIKitPalette.StatusInfoSubtleTransparent20, "Status_Info-Subtle-Transparent_20" },
        { UIKitPalette.StatusLow, "Status_Low" },
        { UIKitPalette.StatusLowSubtle, "Status_Low-Subtle" },
        { UIKitPalette.StatusMedium, "Status_Medium" },
        { UIKitPalette.StatusMediumSubtle, "Status_Medium-Subtle" },
        { UIKitPalette.StatusMediumSubtleTransparent20, "Status_Medium-Subtle-Transparent_20" },
        { UIKitPalette.StatusPositive, "Status_Positive" },
        { UIKitPalette.StatusPositiveSubtle, "Status_Positive-Subtle" },
        { UIKitPalette.StatusPositiveSubtleTransparent20, "Status_Positive-Subtle-Transparent_20" },
