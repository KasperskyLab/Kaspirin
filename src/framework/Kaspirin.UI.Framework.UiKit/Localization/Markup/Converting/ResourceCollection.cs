...
public sealed class ResourceCollection : IDictionary
{
    ...
    private void CheckKeyIsAllowed([NotNull] object? key)
    {
        Guard.ArgumentIsNotNull(key);
    ...
    private IDictionary RealDictionary { get; } = new Dictionary<object, object>();
}
