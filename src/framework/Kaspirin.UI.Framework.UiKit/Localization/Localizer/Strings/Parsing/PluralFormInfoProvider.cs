...
public static class PluralFormInfoProvider
{
    static PluralFormInfoProvider()
    {
    ...
    public static IEnumerable<string> GetSupportedCulturesList() => _rules.Keys.Select(x => x.Name).ToArray();
