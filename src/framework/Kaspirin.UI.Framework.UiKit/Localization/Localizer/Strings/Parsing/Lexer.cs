...
{
    public static IEnumerable<Token> Lex(string sourceText, string sourceName = "<unknown>", bool skipWhiteSpace = true, int startOffset = 0)
    {
        ...
        for (var i = 0; i < sourceText.Length; i++)
        {
            ...
            Token parseIdentifier()
            {
                ...
                i--;
                return new Token(TokenType.Identifier, start, end, sourceName, sourceText);
            }
            ...
            switch (ch)
            {
                ...
                case '\'':
                    {
                        ...
                        {
                            throw new ExpectedSymbolException('\'', startOffset + i, sourceName, sourceText);
                        }
                ...
                case '\u2029': /*  paragraph separator  */
                    {
                        ...
                        i++;
                        skipNewLine();
                        yield return new Token(TokenType.NewNile, start, i, sourceName, sourceText);
                        i--;
                        break;
                    }
                ...
                case var _ when isWhiteSpace(ch):
                    {
                        ...
                        if (!skipWhiteSpace)
                        {
                            yield return new Token(TokenType.WhiteSpace, start, end, sourceName, sourceText);
                        }
                ...
                default:
                    throw new UnexpectedSymbolException(i, sourceName, sourceText);
            }
        }

        yield return new Token(TokenType.Eof, sourceText.Length, sourceText.Length, sourceName, sourceText);
    }
}
