...
public static class Parser
{
    ...
    public static IEnumerable<TItem> ParseScope<TItem, TExpression, TParam, TPluralFormExpression, TOperand>(
            string sourceText,
            string sourceName,
        ...
        => new ParserImpl<TItem, TExpression, TParam, TPluralFormExpression, TOperand>(
                tokens: Lexer.Lex(sourceText, sourceName, skipWhiteSpace, startOffset), evaluator, skipWhiteSpace)
                .ExpectScope();
