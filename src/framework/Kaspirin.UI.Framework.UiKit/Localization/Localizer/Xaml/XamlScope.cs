...
public sealed class XamlScope : IScope<object>
{
    public XamlScope(ResourceItem resource, ResourceProvider resourceProvider)
    {
        ...
        var scopeUri = resource.Uri.AbsoluteUri;
        ...
        {
            var resourceXaml = resourceProvider.ReadResourceString(resource, Encoding.UTF8).TrimStart(_bom);
