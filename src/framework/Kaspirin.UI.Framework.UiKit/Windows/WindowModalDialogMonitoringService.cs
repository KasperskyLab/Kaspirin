...
public sealed class WindowModalDialogMonitoringService
{
    ...
    public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
        "IsEnabled",
        typeof(bool),
        typeof(WindowModalDialogMonitoringService),
    ...
    public static readonly DependencyProperty InstanceProperty = DependencyProperty.RegisterAttached(
        ...
        typeof(WindowModalDialogMonitoringService),
        typeof(WindowModalDialogMonitoringService),
        new PropertyMetadata(default(WindowModalDialogMonitoringService)));
    ...
    private IntPtr WndProc(int code, IntPtr wParam, IntPtr lParam)
    {
        if (code == 0 && lParam != IntPtr.Zero)
        {
            ...
            if (cwp.Message == (uint)WindowMessage.InitDialog)
            {
                ...
                cwp.Message == (uint)WindowMessage.ShowWindow)
            {
    ...
    private void AttachHook()
    {
        ...
        _hookHandle = User32Dll.SetWindowsHookEx(HookType.CallWndProc, hook, IntPtr.Zero, threadId);
