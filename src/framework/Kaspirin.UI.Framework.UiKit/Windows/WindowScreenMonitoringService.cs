...
public sealed class WindowScreenMonitoringService
{
    ...
    public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
        "IsEnabled",
        typeof(bool),
        typeof(WindowScreenMonitoringService),
    ...
    private void Initialize()
    {
        ...
        var hook = new WindowHookBuilder(WindowHooks.DpiDisplayChangedHook)
            .AddHandler<IntPtr, MinMaxInfo>(WindowMessage.GetMinMaxInfo, WndProcOnGetMinMaxInfo)
            .AddHandler<int, NativeRectangle>(WindowMessage.DpiChanged, WndProcOnDpiChanged)
            .AddAsyncHandler<uint, int>(WindowMessage.DisplayChange, WndProcOnDisplayChange)
            .Build();
