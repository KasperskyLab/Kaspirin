...
internal sealed class UIKitContentPresenter : ContentPresenter
{
    ...
    {
        get => (ObservableCollection<UIKitStyleHolder>)GetValue(ContentImpicitStylesProperty);
        set => SetValue(ContentImpicitStylesProperty, value);
    }

    public static readonly DependencyProperty ContentImpicitStylesProperty = DependencyProperty.Register(
        nameof(ContentImpicitStyles),
        typeof(ObservableCollection<UIKitStyleHolder>),
        typeof(UIKitContentPresenter),
        new PropertyMetadata(default(ObservableCollection<UIKitStyleHolder>)));
