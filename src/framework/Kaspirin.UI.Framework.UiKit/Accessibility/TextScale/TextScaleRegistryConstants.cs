...
/// <summary>
///     Constants used to get the text zoom value from the registry.
/// </summary>
public static class TextScaleRegistryConstants
{
    public const string ScaleFactorRegPath = "HKEY_CURRENT_USER\\" + ScaleFactorSubkey;
    public const string ScaleFactorSubkey = "Software\\Microsoft\\Accessibility";
