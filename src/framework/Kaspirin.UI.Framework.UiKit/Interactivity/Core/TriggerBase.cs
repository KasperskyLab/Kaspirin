...
public abstract class TriggerBase : Freezable
{
    ...
    private static readonly DependencyPropertyKey _actionsPropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(Actions),
        typeof(TriggerActionCollection),
        typeof(TriggerBase),
        new FrameworkPropertyMetadata(default(TriggerActionCollection)));
