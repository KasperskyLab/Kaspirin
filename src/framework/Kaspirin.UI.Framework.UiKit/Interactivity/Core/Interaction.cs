...
// This file has been modified by AO Kaspersky Lab in 1/17/2025.
// Scope of modification:
//   - Code style fix.
...
public static class Interaction
{
    ...
    private static readonly DependencyProperty _triggersProperty = DependencyProperty.RegisterAttached(
        "TriggersInternal",
        typeof(TriggerCollection),
        typeof(Interaction),
        new FrameworkPropertyMetadata(default(TriggerCollection), OnTriggersChanged));
    ...
    private static readonly DependencyProperty _behaviorsProperty = DependencyProperty.RegisterAttached(
        "BehaviorsInternal",
        typeof(BehaviorCollection),
        typeof(Interaction),
        new FrameworkPropertyMetadata(default(BehaviorCollection), OnBehaviorsChanged));
