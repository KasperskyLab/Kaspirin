...
namespace Kaspirin.UI.Framework.UiKit.ThirdParty.HtmlUtils
{
    ...
    /// </summary>
    internal sealed class HtmlToXamlConverter
    {
        private HtmlToXamlConverter(string basePath)
        {
            _basePath = basePath;
        }
        ...
        public const string XamlImage = "Image";
        public const string XamlImageSource = "Source";
        ...
        public const string XamlHeight = "Height";
        ...
        public const string XamlFontSizeXxLarge = "28"; // "XXLarge";
        public const string XamlFontSizeXLarge = "20"; // "XLarge";
        public const string XamlFontSizeLarge = "18"; // "Large";
        public const string XamlFontSizeMedium = "16"; // "Medium";
        public const string XamlFontSizeSmall = "14"; // "Small";
        public const string XamlFontSizeXSmall = "12"; // "XSmall";
        public const string XamlFontSizeXxSmall = "10"; // "XXSmall";
        ...
        public const string XamlTextDecorationsStrikethrough = "Strikethrough";
        public const string XamlTextIndent = "TextIndent";
        public const string XamlTextAlignment = "TextAlignment";
        public const string XamlVerticalAlignment = "VerticalAlignment";
        public const string XamlLineHeight = "LineHeight";
        public const string XamlBaselineAlignment = "BaselineAlignment";
        public const string XamlFigure = "Figure";
        public const string XamlBlockUIContainer = "BlockUIContainer";
        public const string XamlSeparator = "Separator";
        public const string XamlStretch = "Stretch";
        public const string XamlStretchFill = "Fill";
        ...
        private static readonly string VisualsNamespace = "http://schemas.kaspirin.com/common/visuals";
        ...
        /// </returns>
        public static string ConvertHtmlToXaml(string htmlString, bool asFlowDocument, string basePath)
        {
            return new HtmlToXamlConverter(basePath).ConvertHtmlToXaml(htmlString, asFlowDocument);
        }

        public string ConvertHtmlToXaml(string htmlString, bool asFlowDocument)
        {
            ...
            xamlFlowDocumentElement.SetAttribute("xmlns:x", XNamespace);
            xamlFlowDocumentElement.SetAttribute("xmlns:visuals", VisualsNamespace);

            // Extract style definitions from all STYLE elements in the document
            var stylesheet = new CssStylesheet(htmlElement, _basePath);
        ...
        public static string GetAttribute(XmlElement element, string attributeName)
        {
            ...
            {
                if (element.Attributes[i].Name.ToLowerInvariant() == attributeName)
                {
        ...
        internal static string GetFullPath(string relativePath, string basePath)
        {
            Guard.Argument(Uri.IsWellFormedUriString(relativePath, UriKind.Relative));
#if NET40
        ...
        /// </returns>
        private XmlNode AddBlock(XmlElement xamlParentElement, XmlNode htmlNode, Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else if (htmlNode is XmlElement)
            {
                ...
                Guard.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == htmlElement);
        ...
        private static void AddBreak(XmlElement xamlParentElement, string htmlElementName)
        {
            ...
            {
                var xamlFigure = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
                    null, /*localName:*/XamlFigure, XamlNamespace);
                var xamlBlockUIContainer = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
                    null, /*localName:*/XamlBlockUIContainer, XamlNamespace);
                var xamlSeparator = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
                    null, /*localName:*/XamlSeparator, XamlNamespace);

                xamlParentElement.AppendChild(xamlFigure);
                xamlFigure.AppendChild(xamlBlockUIContainer);
                xamlBlockUIContainer.AppendChild(xamlSeparator);
            }
        }
        ...
        /// </param>
        private void AddSection(XmlElement xamlParentElement, XmlElement htmlElement,
            ...
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
                ...
                htmlChildNode = htmlChildNode.NextSibling)
            {
                ...
                {
                    var htmlChildName = ((XmlElement)htmlChildNode).LocalName.ToLowerInvariant();
            ...
            else
            {
                ...
                var currentProperties = GetElementProperties(htmlElement, inheritedProperties, out var localProperties,
                    stylesheet,
                    sourceContext);
        ...
        /// true indicates that a content added by this call contains at least one block element
        /// </param>
        private void AddParagraph(XmlElement xamlParentElement, XmlElement htmlElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Create currentProperties as a compilation of local and inheritedProperties, set localProperties
        ...
        /// </returns>
        private XmlNode AddImplicitParagraph(XmlElement xamlParentElement, XmlNode htmlNode,
            Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            while (htmlNode != null)
            {
                ...
                {
                    var htmlChildName = ((XmlElement)htmlNode).LocalName.ToLowerInvariant();
                    if (HtmlSchema.IsBlockElement(htmlChildName))
                    {
        ...
        private void AddInline(XmlElement xamlParentElement, XmlNode htmlNode, Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            if (htmlNode is XmlComment)
            {
            ...
            else if (htmlNode is XmlElement)
            {
                ...
                // Identify element name
                var htmlElementName = htmlElement.LocalName.ToLowerInvariant();
        ...
        private void AddSpanOrRun(XmlElement xamlParentElement, XmlElement htmlElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
        ...
        private void AddHyperlink(XmlElement xamlParentElement, XmlElement htmlElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                xamlElement.SetAttribute(XamlHyperlinkNavigateUri, href);
        ...
        private void AddImage(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Convert href attribute into NavigateUri and TargetName
            var src = GetAttribute(htmlElement, "src").Trim();
            if (string.IsNullOrEmpty(src))
            {
                return;
            }

            var imageSource = GetFullPath(src, _basePath);
            ...
            // Create currentProperties as a compilation of local and inheritedProperties, set localProperties
            GetElementProperties(htmlElement, inheritedProperties, out var localProperties,
                stylesheet,
                sourceContext);

            // Create a XAML element corresponding to this html element
            var xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/
                null, /*localName:*/XamlImage, XamlNamespace);
            ApplyLocalProperties(xamlElement, localProperties, /*isBlock:*/false);
            xamlElement.SetAttribute(XamlImageSource, new Uri(imageSource).AbsoluteUri);
        ...
        /// <param name="stylesheet"></param>
        /// <param name="sourceContext"></param>
        private void AddList(XmlElement xamlParentElement, XmlElement htmlListElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            var htmlListElementName = htmlListElement.LocalName.ToLowerInvariant();

            var currentProperties = GetElementProperties(htmlListElement, inheritedProperties, out var localProperties,
            ...
            for (var htmlChildNode = htmlListElement.FirstChild;
                ...
                htmlChildNode = htmlChildNode.NextSibling)
            {
                if (htmlChildNode is XmlElement && htmlChildNode.LocalName.ToLowerInvariant() == "li")
                {
                    ...
                    AddListItem(xamlListElement, (XmlElement)htmlChildNode, currentProperties, stylesheet,
                        sourceContext);
                    Guard.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == htmlChildNode);
                    sourceContext.RemoveAt(sourceContext.Count - 1);
                }
            }
        ...
        /// </returns>
        private XmlElement AddOrphanListItems(XmlElement xamlParentElement, XmlElement htmlLiElement,
            Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            var htmlChildNodeName = htmlChildNode?.LocalName.ToLowerInvariant();
        ...
        ///     Properties inherited from parent context
        /// </param>
        private void AddListItem(XmlElement xamlListElement, XmlElement htmlLiElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Guard.Assert(xamlListElement != null);
            Guard.Assert(xamlListElement.LocalName == XamlList);
            Guard.Assert(htmlLiElement != null);
            Guard.Assert(htmlLiElement.LocalName.ToLowerInvariant() == "li");
            Guard.Assert(inheritedProperties != null);

            var currentProperties = GetElementProperties(htmlLiElement, inheritedProperties, out var localProperties,
                stylesheet, sourceContext);

            var xamlListItemElement = xamlListElement.OwnerDocument.CreateElement(null, XamlListItem,
                XamlNamespace);

            ApplyLocalProperties(xamlListItemElement, localProperties, isBlock: false);
        ...
        /// </param>
        private void AddTable(XmlElement xamlParentElement, XmlElement htmlTableElement,
            Hashtable inheritedProperties,
            CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Guard.Assert(htmlTableElement.LocalName.ToLowerInvariant() == "table");
            Guard.Assert(xamlParentElement != null);
            Guard.Assert(inheritedProperties != null);
            ...
            if (singleCell != null)
            {
                ...
                Guard.Assert(sourceContext.Count > 0 && sourceContext[sourceContext.Count - 1] == singleCell);
                sourceContext.RemoveAt(sourceContext.Count - 1);
            }
            else
            {
                ...
                {
                    var htmlChildName = htmlChildNode.LocalName.ToLowerInvariant();
                    ...
                    if (htmlChildName == "tbody" || htmlChildName == "thead" || htmlChildName == "tfoot")
                    {
                        ...
                        var tbodyElementCurrentProperties = GetElementProperties((XmlElement)htmlChildNode,
                            currentProperties,
                            out _, stylesheet, sourceContext);
        ...
        private static XmlElement GetCellFromSingleCellTable(XmlElement htmlTableElement)
        {
                ...
                tableChild = tableChild.NextSibling)
            {
                ...
                if (elementName == "tbody" || elementName == "thead" || elementName == "tfoot")
                {
                        ...
                        tbodyChild = tbodyChild.NextSibling)
                    {
                        if (tbodyChild.LocalName.ToLowerInvariant() == "tr")
                        {
                            ...
                            {
                                var cellName = trChild.LocalName.ToLowerInvariant();
                ...
                else if (tableChild.LocalName.ToLowerInvariant() == "tr")
                {
                    if (singleCell != null)
                    {
                        return null;
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                for (var htmlChildNode = htmlTableElement.FirstChild;
                    ...
                    htmlChildNode = htmlChildNode.NextSibling)
                {
                    if (htmlChildNode.LocalName.ToLowerInvariant() == "colgroup")
                    {
                    ...
                    else if (htmlChildNode.LocalName.ToLowerInvariant() == "col")
                    {
            ...
            Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            {
                if (htmlNode is XmlElement && htmlNode.LocalName.ToLowerInvariant() == "col")
                {
        ...
        private static void AddTableColumn(XmlElement xamlTableElement, XmlElement htmlColElement,
            Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            var currentProperties = GetElementProperties(htmlColElement, inheritedProperties, out _,
                stylesheet, sourceContext);
        ...
        /// </returns>
        private XmlNode AddTableRowsToTableBody(XmlElement xamlTableBodyElement, XmlNode htmlTrStartNode,
            Hashtable currentProperties, ArrayList columnStarts, CssStylesheet stylesheet,
            List<XmlElement> sourceContext)
        {
            // Parameter validation
            Guard.Assert(xamlTableBodyElement.LocalName == XamlTableRowGroup);
            Guard.Assert(currentProperties != null);
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLowerInvariant() != "tbody")
            {
                if (htmlChildNode.LocalName.ToLowerInvariant() == "tr")
                {
                ...
                else if (htmlChildNode.LocalName.ToLowerInvariant() == "td")
                {
                    ...
                    Guard.Assert(columnStarts == null);
        ...
        /// </returns>
        private XmlNode AddTableCellsToTableRow(XmlElement xamlTableRowElement, XmlNode htmlTdStartNode,
            Hashtable currentProperties, ArrayList columnStarts, ArrayList activeRowSpans, CssStylesheet stylesheet,
            List<XmlElement> sourceContext)
        {
            // parameter validation
            Guard.Assert(xamlTableRowElement.LocalName == XamlTableRow);
            Guard.Assert(currentProperties != null);
            if (columnStarts != null)
            {
                Guard.Assert(activeRowSpans.Count == columnStarts.Count);
            }
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLowerInvariant() != "tr" &&
                   htmlChildNode.LocalName.ToLowerInvariant() != "tbody" && htmlChildNode.LocalName.ToLowerInvariant() != "thead" &&
                   htmlChildNode.LocalName.ToLowerInvariant() != "tfoot")
            {
                if (htmlChildNode.LocalName.ToLowerInvariant() == "td" || htmlChildNode.LocalName.ToLowerInvariant() == "th")
                {
                    ...
                    if (columnStarts != null)
                    {
                        Guard.Assert(columnIndex < columnStarts.Count - 1);
                        while (columnIndex < activeRowSpans.Count && (int)activeRowSpans[columnIndex] > 0)
                        {
                            ...
                            Guard.Assert((int)activeRowSpans[columnIndex] >= 0);
                            columnIndex++;
                        }
                        ...
                        Guard.Assert(columnSpan > 0);
                        Guard.Assert(columnIndex + columnSpan < columnStarts.Count);
                        ...
                        for (var spannedColumnIndex = columnIndex;
                            ...
                            spannedColumnIndex++)
                        {
                            Guard.Assert(spannedColumnIndex < activeRowSpans.Count);
                            activeRowSpans[spannedColumnIndex] = rowSpan - 1;
                            Guard.Assert((int)activeRowSpans[spannedColumnIndex] >= 0);
                        }
        ...
        /// </param>
        private void AddDataToTableCell(XmlElement xamlTableCellElement, XmlNode htmlDataStartNode,
            Hashtable currentProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Guard.Assert(xamlTableCellElement.LocalName == XamlTableCell);
            Guard.Assert(currentProperties != null);
        ...
        private static ArrayList AnalyzeTableStructure(XmlElement htmlTableElement, CssStylesheet stylesheet)
        {
            ...
            Guard.Assert(columnStarts.Count == activeRowSpans.Count);
        ...
        {
            // Parameter validation
            Guard.Assert(htmlTbodyElement.LocalName.ToLowerInvariant() == "tbody");
            Guard.Assert(columnStarts != null);
            ...
            double tableWidth, CssStylesheet stylesheet)
        {
            ...
            // Parameter validation
            Guard.Assert(htmlTrElement.LocalName.ToLowerInvariant() == "tr");
            Guard.Assert(columnStarts != null);
            Guard.Assert(activeRowSpans != null);
            Guard.Assert(columnStarts.Count == activeRowSpans.Count);
            ...
            {
                Guard.Assert((double)columnStarts[columnIndex] >= columnStart);
            ...
            while (htmlChildNode != null && columnWidthsAvailable)
            {
                ...
                {
                    case "td":
                        Guard.Assert(columnIndex <= columnStarts.Count);
                        if (columnIndex < columnStarts.Count)
                        {
                            Guard.Assert(columnStart <= (double)columnStarts[columnIndex]);
                        ...
                        if (columnWidth != -1)
                        {
                            ...
                            if (nextColumnIndex != -1)
                            {
                                ...
                                Guard.Assert(nextColumnIndex <= columnStarts.Count);
            ...
            ArrayList activeRowSpans)
        {
            ...
            // Parameter validation
            Guard.Assert(columnStarts != null);
            Guard.Assert(0 <= columnIndex && columnIndex <= columnStarts.Count);
            Guard.Assert(columnWidth > 0);
        ...
        private static double GetNextColumnStart(XmlElement htmlTdElement, double columnStart)
        {
            ...
            // Parameter validation
            Guard.Assert(htmlTdElement.LocalName.ToLowerInvariant() == "td" || htmlTdElement.LocalName.ToLowerInvariant() == "th");

            Guard.Assert(columnStart >= 0);
        ...
        private static double GetColumnWidth(XmlElement htmlTdElement)
        {
            ...
            var columnWidthAsString = GetAttribute(htmlTdElement, "width") ??
        ...
        private static int CalculateColumnSpan(int columnIndex, double columnWidth, ArrayList columnStarts)
        {
            Guard.Assert(columnStarts != null);
            Guard.Assert(columnIndex < columnStarts.Count - 1);
            Guard.Assert((double)columnStarts[columnIndex] >= 0);
            Guard.Assert(columnWidth > 0);

            var columnSpanningIndex = columnIndex;
            double columnSpanningValue = 0; // Current status of column width. Indicates the amount of width that has been scanned already
            double subColumnWidth = 0; // Width of the smallest-grain columns in the table
        ...
        private static void VerifyColumnStartsAscendingOrder(ArrayList columnStarts)
        {
            ...
            foreach (var t in columnStarts)
            {
                Guard.Assert(columnStart < (double)t);
        ...
        private static void ApplyLocalProperties(XmlElement xamlElement, Hashtable localProperties, bool isBlock)
        {
            ...
            while (propertyEnumerator.MoveNext())
            {
                switch ((string)propertyEnumerator.Key)
                {
                    ...
                    case "font-weight":
                        SetFontWeight(xamlElement, (string)propertyEnumerator.Value);
                        break;

                    case "font-size":
                        //  Convert from css size into FontSize
                        SetFontSize(xamlElement, (string)propertyEnumerator.Value);
                        break;
                    ...
                    case "line-height":
                        xamlElement.SetAttribute(XamlLineHeight, (string)propertyEnumerator.Value);
                        break;
                    ...
                    case "text-decoration-line-through":
                        if (!isBlock)
                        {
                            if ((string)propertyEnumerator.Value == "true")
                            {
                                xamlElement.SetAttribute(XamlTextDecorations, XamlTextDecorationsStrikethrough);
                            }
                        }
                    ...
                    case "vertical-align":
                        if (!isBlock)
                        {
                            switch ((string)propertyEnumerator.Value)
                            {
                                case "sub":
                                    xamlElement.SetAttribute(XamlBaselineAlignment, BaselineAlignment.Subscript.ToString());
                                    break;
                                case "super":
                                    xamlElement.SetAttribute(XamlBaselineAlignment, BaselineAlignment.Superscript.ToString());
                                    break;
                            }
                        }
                    ...
                    case "width":
                        xamlElement.SetAttribute(XamlWidth, (string)propertyEnumerator.Value);
                        break;
                    case "height":
                        xamlElement.SetAttribute(XamlHeight, (string)propertyEnumerator.Value);
                        break;
                    ...
                    case "list-style-type":
                        ...
                        {
                            string markerStyle;
                            switch (((string)propertyEnumerator.Value).ToLowerInvariant())
                            {
                                case "disc":
                    ...
                    case "object-fit":
                        ...
                        switch ((string)propertyEnumerator.Value)
                        {
                            case "contain":
                            case "scale-down":
                                stretch = Stretch.Uniform.ToString();
                                break;
                            case "cover":
                                stretch = Stretch.UniformToFill.ToString();
                                break;
                            case "fill":
                                stretch = Stretch.Fill.ToString();
                                break;
                            default:
                                stretch = Stretch.None.ToString();
                                break;
                        }

                        xamlElement.SetAttribute(XamlStretch, stretch);
                        break;
                }
            }
        ...
        private static void SetFontWeight(XmlElement xamlElement, string value)
        {
            if (int.TryParse(value, out var weightValue))
            {
                xamlElement.SetAttribute(XamlFontWeight, FontWeight.FromOpenTypeWeight(weightValue).ToString());
            }
            else
            {
                xamlElement.SetAttribute(XamlFontWeight, value);
            }
        }

        private static void SetFontSize(XmlElement xamlElement, string value)
        {
            string fontSize;
            switch (value)
            {
                case "xx-small":
                    fontSize = XamlFontSizeXxSmall;
                    break;

                case "x-small":
                    fontSize = XamlFontSizeXSmall;
                    break;

                case "small":
                    fontSize = XamlFontSizeSmall;
                    break;

                case "medium":
                    fontSize = XamlFontSizeMedium;
                    break;

                case "large":
                    fontSize = XamlFontSizeLarge;
                    break;

                case "x-large":
                    fontSize = XamlFontSizeXLarge;
                    break;

                case "xx-large":
                    fontSize = XamlFontSizeXxLarge;
                    break;

                case "larger":
                    fontSize = (1 / 0.83).ToString().Replace(',', '.') + "em";
                    break;
            ...
            var number = new string(fontSize.TakeWhile(c => char.IsDigit(c) || c == '.').ToArray());
            var unit = fontSize.Substring(number.Length).Trim();
            switch (unit)
            {
                case "em":
                    xamlElement.SetAttribute(
                        TextElement.FontSizeProperty.Name,
                        "{Binding FontSize, RelativeSource={RelativeSource AncestorType={x:Type TextElement}}"
                        + $", Converter={{visuals:{nameof(MultiplierConverter)} Factor={number}}}}}");
                    break;
                default:
                    xamlElement.SetAttribute(TextElement.FontSizeProperty.Name, number);
                    break;
            }
        }
            ...
            out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            // Identify element name
            var elementName = htmlElement.LocalName.ToLowerInvariant();
            ...
            switch (elementName)
            {
                ...
                case "sub":
                    localProperties["font-size"] = "smaller";
                ...
                case "h1":
                    localProperties["font-size"] = "2em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;

                case "h2":
                    localProperties["font-size"] = "1.5em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;

                case "h3":
                    localProperties["font-size"] = "1.17em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;

                case "h4":
                    localProperties["font-size"] = "1.00em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;

                case "h5":
                    localProperties["font-size"] = "0.83em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;

                case "h6":
                    localProperties["font-size"] = "0.67em";
                    localProperties["font-weight"] = XamlFontWeightBold;
                    break;
                ...
                case "big":
                    localProperties["font-size"] = "larger";
                    break;
                ...
                case "img":
                    {
                        var attributeValue = GetAttribute(htmlElement, "width");
                        if (attributeValue != null)
                        {
                            localProperties["width"] = attributeValue;
                        }

                        attributeValue = GetAttribute(htmlElement, "height");
                        if (attributeValue != null)
                        {
                            localProperties["height"] = attributeValue;
                        }

                        localProperties["object-fit"] = "fill";
                    }
        ...
        private static string GetCssAttribute(string cssStyle, string attributeName)
        {
            ...
            if (cssStyle != null)
            {
                ...
                foreach (var t in styleValues)
                {
                    ...
                    {
                        if (styleNameValue[0].Trim().ToLowerInvariant() == attributeName)
                        {
        ...
        {
            // Parameter validation
            Guard.Assert(htmlChildNode.LocalName.ToLowerInvariant() == "td" || htmlChildNode.LocalName.ToLowerInvariant() == "th");
            Guard.Assert(xamlTableCellElement.LocalName == XamlTableCell);
