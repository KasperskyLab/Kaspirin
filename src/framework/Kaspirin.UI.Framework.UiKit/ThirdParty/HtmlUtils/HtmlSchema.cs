...
namespace Kaspirin.UI.Framework.UiKit.ThirdParty.HtmlUtils
{
    ...
    internal sealed class HtmlSchema
    {
        ...
        /// </param>
        internal static bool IsEmptyElement(string xmlElementName) => _htmlEmptyElements.Contains(xmlElementName.ToLowerInvariant());
        ...
        ///     string representing name to test
        /// </param>
        internal static bool ClosesOnParentElementEnd(string xmlElementName) => _htmlElementsClosingOnParentElementEnd.Contains(xmlElementName.ToLowerInvariant());
        ...
        {
            Guard.Assert(currentElementName == currentElementName.ToLowerInvariant());
