...
public sealed class Select : Selector
{
    ...
    {
        get => (bool)GetValue(IsFilterHasResultProperty);
        private set => SetValue(_isFilterHasResultPropertyKey, value);
    }

    private static readonly DependencyPropertyKey _isFilterHasResultPropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(IsFilterHasResult),
        typeof(bool),
        typeof(Select),
    ...
    {
        get => (double)GetValue(SelectWidthProperty);
        set => SetValue(SelectWidthProperty, value);
    }

    public static readonly DependencyProperty SelectWidthProperty = DependencyProperty.Register(
        nameof(SelectWidth),
        typeof(double),
        typeof(Select),
    ...
    {
        get => (HorizontalAlignment)GetValue(SelectHorizontalAlignmentProperty);
        set => SetValue(SelectHorizontalAlignmentProperty, value);
    }

    public static readonly DependencyProperty SelectHorizontalAlignmentProperty = DependencyProperty.Register(
        nameof(SelectHorizontalAlignment),
