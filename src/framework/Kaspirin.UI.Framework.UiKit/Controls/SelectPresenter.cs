...
using BooleanToVisibilityConverter = Kaspirin.UI.Framework.UiKit.Converters.BooleanConverters.BooleanToVisibilityConverter;
...
internal sealed class SelectPresenter : Button
{
    ...
    public override void OnApplyTemplate()
    {
        ...
        _image.SetBinding(WpfImage.SourceProperty, new Binding() { Source = this, Path = _imageProperty.AsPath() });
        _image.SetBinding(WpfImage.FlowDirectionProperty, new Binding() { Source = this, Path = _imageFlowDirectionProperty.AsPath() });
        ...
        _textInput.SetBinding(TextInputControl.InputFilterProperty, new Binding()
        {
            Source = this,
