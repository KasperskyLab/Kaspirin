...
internal sealed class DateTimePopupPresenter : Control
{
    ...
    {
        _dateTimeDisplayInfo = LocalizationManager.DisplayCulture.CultureInfo.DateTimeFormat;
        _dateTimeFormatInfo = LocalizationManager.FormatCulture.CultureInfo.DateTimeFormat;
