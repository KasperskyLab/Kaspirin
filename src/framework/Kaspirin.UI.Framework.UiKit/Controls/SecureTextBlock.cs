...
public sealed class SecureTextBlock : Control
{
    ...
    private double GetPaddingHorizontalOffset(double textWidth)
    {
        return TextAlignment switch
        {
            ...
            _ => throw new UnexpectedValueException(TextAlignment)
        };
    }
    ...
    private static void ApplyArabicPresentationForms(List<char> chars)
    {
        ...
        while (++i < chars.Count)
        {
            ...
            if (ArabicLetter.IsAlifChar(currentChar) && prevChar == ArabicLetter.Lam)
            {
                ...
                {
                    ArabicLetter.Alif => ArabicLetter.LamWithAlif,
                    ArabicLetter.AlifMaddah => ArabicLetter.LamWithAlifMaddah,
                    ArabicLetter.AlifHamzaA => ArabicLetter.LamWithAlifHamzaA,
                    ArabicLetter.AlifHamzaB => ArabicLetter.LamWithAlifHamzaB,
                    _ => throw new UnexpectedValueException(currentChar)
                };
