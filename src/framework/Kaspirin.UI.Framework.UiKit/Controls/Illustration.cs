...
public sealed class Illustration : Control
{
    ...
    public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(
        ...
        typeof(Enum),
        typeof(Illustration),
        new PropertyMetadata(default(Enum), OnSourceChanged));
    ...
    private static void OnSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        illustrationControl.ApplySource();
    }
    ...
    private static readonly DependencyPropertyKey _isUnsetPropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(IsUnset),
        typeof(bool),
        typeof(Illustration),
        new PropertyMetadata(default(bool)));

    public static readonly DependencyProperty IsUnsetProperty = _isUnsetPropertyKey.DependencyProperty;
    ...
    private void ApplyFlowDirection(UIKitIllustrationMetadata? illustrationMetadata)
    {
        ...
        {
            _image.SetValue(FlowDirectionProperty, LocalizationManager.DisplayCulture.FlowDirection);
        }
        else
        {
    ...
    {
        Executers.InUiSyncOrAsync(ApplySource);
    }
