...
public sealed class ImageGallery : Control
{
    ...
    public static readonly DependencyProperty ImageSourcesProperty = DependencyProperty.Register(
        ...
        typeof(ImageGallery),
        new PropertyMetadata(default(ObservableCollection<ImageSource>), OnImageSourcesChanged));
    ...
    public static readonly DependencyProperty SelectedImageProperty = DependencyProperty.Register(
        ...
        typeof(ImageSource),
        typeof(ImageGallery),
        new PropertyMetadata(default(ImageSource), OnSelectedImageChanged));
    ...
    {
        get => (ImageGalleryNavigationMode)GetValue(NavigationModeProperty);
    ...
    public static readonly DependencyProperty NavigationModeProperty = DependencyProperty.Register(
        ...
        typeof(ImageGalleryNavigationMode),
        typeof(ImageGallery),
    ...
    {
        get => (ImageGalleryNavigationMode)GetValue(ActualNavigationModeProperty);
        private set => SetValue(_actualNavigationModePropertyKey, value);
    }

    private static readonly DependencyPropertyKey _actualNavigationModePropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(ActualNavigationMode),
        typeof(ImageGalleryNavigationMode),
        typeof(ImageGallery),
        new PropertyMetadata(ImageGalleryNavigationMode.ArrowsAndCarousel));

    public static readonly DependencyProperty ActualNavigationModeProperty = _actualNavigationModePropertyKey.DependencyProperty;
