...
public sealed class ContextMenu : System.Windows.Controls.ContextMenu
{
    ...
    public static readonly DependencyProperty OnCloseCommandProperty = DependencyProperty.Register(
    ...
    public static readonly DependencyProperty OnOpenCommandProperty = DependencyProperty.Register(
    ...
    public static readonly DependencyProperty ItemElementProperty = UIKitItemsControlHelper.ItemElementProperty
    ...
    public static readonly DependencyProperty ItemElementSelectorProperty = UIKitItemsControlHelper.ItemElementSelectorProperty
        .AddOwner(typeof(ContextMenu));
