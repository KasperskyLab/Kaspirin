...
public sealed class RoundTimer : Control
{
    ...
    {
        get => (RoundTimerType)GetValue(TypeProperty);
        set => SetValue(TypeProperty, value);
    }

    public static readonly DependencyProperty TypeProperty = DependencyProperty.Register(
        nameof(Type),
        typeof(RoundTimerType),
        typeof(RoundTimer),
        new PropertyMetadata(RoundTimerType.Positive));
    ...
    private static readonly DependencyProperty _remainingTicksProperty = DependencyProperty.Register(
        "RemainingTicks",
        typeof(long),
    ...
    private void StartTimer()
    {
        ...
        if (IsLoaded)
        {
            ...
            Executers.InUiAsync(InvalidateAnimation, DispatcherPriority.Background);
        }
    }
