...
public sealed class WindowLocationStoreBehavior : Behavior<Window, WindowLocationStoreBehavior>
{
    ...
    public static IKeyValueStorage GetStorage(DependencyObject dependencyObject)
        => (IKeyValueStorage)dependencyObject.GetValue(StorageProperty);
    ...
    public static readonly DependencyProperty StorageProperty = DependencyProperty.RegisterAttached(
        "Storage",
        typeof(IKeyValueStorage),
        typeof(WindowLocationStoreBehavior),
    ...
    public static WindowLocationProvider GetLocationProvider(DependencyObject dependencyObject)
        => (WindowLocationProvider)dependencyObject.GetValue(LocationProviderProperty);
    ...
    public static readonly DependencyProperty LocationProviderProperty = DependencyProperty.RegisterAttached(
        "LocationProvider",
        typeof(WindowLocationProvider),
        typeof(WindowLocationStoreBehavior),
    ...
    private static bool IsWindowOutOfBound(Window window, Point leftTop)
    {
        ...
        var windowRect = new Rectangle((int)leftTop.X, (int)leftTop.Y, (int)window.Width, (int)window.Height);
    ...
    private sealed class WindowPositionOrSizeChangedWindowHook : WindowHookBase
    {
            ...
            : base(window, hookId, $"{hookId} for {windowId}")
        {
            ...
            _hook = new WindowHookBuilder(hookId)
                .AddAsyncHandler<int, int>(WindowMessage.EnterSizeMove, WndProcOnEnterSizeMove)
                .AddAsyncHandler<int, int>(WindowMessage.ExitSizeMove, WndProcOnExitSizeMove)
                .AddAsyncHandler<int, int>(WindowMessage.Move, WndProcOnMove)
                .AddAsyncHandler<int, int>(WindowMessage.Size, WndProcOnSize)
                .Build();
        }
        ...
        private void WndProcOnSize(int? wParam, int? lParam)
        {
            ...
            {
                TraceInformation(window, $"WM_SIZE received but loword '{loword}' or hiword '{hiword}' is less than zero");
                return;
            }
