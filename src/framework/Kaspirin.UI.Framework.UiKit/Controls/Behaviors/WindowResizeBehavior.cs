...
public static class WindowResizeBehavior
{
    ...
    public static bool GetIsWindowResizeLayer(DependencyObject obj)
        => (bool)obj.GetValue(IsWindowResizeLayerProperty);

    public static void SetIsWindowResizeLayer(DependencyObject obj, bool value)
        => obj.SetValue(IsWindowResizeLayerProperty, value);

    public static readonly DependencyProperty IsWindowResizeLayerProperty = DependencyProperty.RegisterAttached(
        "IsWindowResizeLayer",
        typeof(bool),
        typeof(WindowResizeBehavior),
        new PropertyMetadata(default(bool), OnIsWindowResizeLayerChanged));
