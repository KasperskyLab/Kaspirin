...
public sealed class HtmlBlock : Section
{
    ...
    public static readonly DependencyProperty HtmlProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(HtmlBlock),
        new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.AffectsRender, OnHtmlChanged));

    private static void OnHtmlChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        => ((HtmlBlock)d).UpdateContent();
    ...
    public static readonly DependencyProperty HtmlSourceProperty = DependencyProperty.Register(
        ...
        typeof(Uri),
        typeof(HtmlBlock),
        new FrameworkPropertyMetadata(default(Uri), FrameworkPropertyMetadataOptions.AffectsRender, OnHtmlSourceChanged));

    private static void OnHtmlSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        => ((HtmlBlock)d).LoadHtmlFromSource();
    ...
    public static readonly DependencyProperty BasePathProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(HtmlBlock),
        new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.AffectsRender, OnBasePathChanged));
    ...
    private static readonly DependencyPropertyKey _hasParsingErrorsPropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(HasParsingErrors),
        typeof(bool),
        typeof(HtmlBlock),
        new PropertyMetadata(default(bool)));

    public static readonly DependencyProperty HasParsingErrorsProperty = _hasParsingErrorsPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty HyperlinkNavigationProperty = DependencyProperty.Register(
    ...
    private bool TryParseXaml(string xaml, out Block? contentBlock)
    {
        try
        {
            contentBlock = (Block)XamlReader.Parse(xaml);
            return true;
        }
        catch (Exception ex)
        {
