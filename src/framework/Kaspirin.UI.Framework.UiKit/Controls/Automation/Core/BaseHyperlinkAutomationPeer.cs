...
public abstract class BaseHyperlinkAutomationPeer<TControl> :
    HyperlinkAutomationPeer, IAutomationPeer, IAccessibilityAware
    where TControl : Hyperlink
{
    protected BaseHyperlinkAutomationPeer(TControl control) : base(control)
    {
