...
public abstract class BaseFrameworkElementAutomationPeer<TControl> :
    FrameworkElementAutomationPeer, IAutomationPeer, IAccessibilityAware
    where TControl : FrameworkElement
{
    protected BaseFrameworkElementAutomationPeer(TControl control) : base(control)
    {
