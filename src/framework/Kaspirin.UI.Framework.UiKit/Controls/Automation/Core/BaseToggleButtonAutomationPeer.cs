...
public abstract class BaseToggleButtonAutomationPeer<TControl> :
    ToggleButtonAutomationPeer, IAutomationPeer, IAccessibilityAware
    where TControl : ToggleButton
{
    protected BaseToggleButtonAutomationPeer(TControl control) : base(control)
    {
