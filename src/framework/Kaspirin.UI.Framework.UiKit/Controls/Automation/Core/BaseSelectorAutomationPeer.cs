...
public abstract class BaseSelectorAutomationPeer<TControl> :
    SelectorAutomationPeer, IAutomationPeer, IAccessibilityAware
    where TControl : Selector
{
    protected BaseSelectorAutomationPeer(TControl control) : base(control)
    {
