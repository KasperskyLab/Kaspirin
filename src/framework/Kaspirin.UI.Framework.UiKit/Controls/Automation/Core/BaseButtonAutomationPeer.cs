...
public abstract class BaseButtonAutomationPeer<TControl> :
    ButtonAutomationPeer, IAutomationPeer, IAccessibilityAware
    where TControl : Button
{
    protected BaseButtonAutomationPeer(TControl control) : base(control)
    {
