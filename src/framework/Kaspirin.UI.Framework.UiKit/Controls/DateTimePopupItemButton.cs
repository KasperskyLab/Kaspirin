...
internal sealed class DateTimePopupItemButton : Button
{
    ...
    public static readonly DependencyProperty CurrentOffsetProperty = DependencyProperty.Register(
        nameof(CurrentOffset),
        typeof(double),
        typeof(DateTimePopupItemButton),
        new PropertyMetadata(default(double), OnCurrentOffsetChanged));
    ...
    private static readonly DependencyPropertyKey _isAvailablePropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(IsAvailable),
        typeof(bool),
        typeof(DateTimePopupItemButton),
        new PropertyMetadata(true));

    public static readonly DependencyProperty IsAvailableProperty = _isAvailablePropertyKey.DependencyProperty;
    ...
    private static readonly DependencyPropertyKey _isSelectedPropertyKey = DependencyProperty.RegisterReadOnly(
        nameof(IsSelected),
        typeof(bool),
        typeof(DateTimePopupItemButton),
        new PropertyMetadata(default(bool)));

    public static readonly DependencyProperty IsSelectedProperty = _isSelectedPropertyKey.DependencyProperty;
