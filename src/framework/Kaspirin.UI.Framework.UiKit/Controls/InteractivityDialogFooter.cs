...
public sealed class InteractivityDialogFooter : Control
{
    ...
    #region IsPrimaryBusyButton

    public bool IsPrimaryBusyButton
    {
        get => (bool)GetValue(IsPrimaryBusyButtonProperty);
        set => SetValue(IsPrimaryBusyButtonProperty, value);
    }

    public static readonly DependencyProperty IsPrimaryBusyButtonProperty = DependencyProperty.Register(
        nameof(IsPrimaryBusyButton),
        typeof(bool),
        typeof(InteractivityDialogFooter),
        new PropertyMetadata(default(bool)));
    ...
    #region IsSecondaryBusyButton

    public bool IsSecondaryBusyButton
    {
        get => (bool)GetValue(IsSecondaryBusyButtonProperty);
        set => SetValue(IsSecondaryBusyButtonProperty, value);
    }

    public static readonly DependencyProperty IsSecondaryBusyButtonProperty = DependencyProperty.Register(
        nameof(IsSecondaryBusyButton),
        typeof(bool),
        typeof(InteractivityDialogFooter),
        new PropertyMetadata(default(bool)));
