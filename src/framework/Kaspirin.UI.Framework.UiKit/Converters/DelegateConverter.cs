...
{
    /// <summary>
    ///     Provides an implementation of <see cref="IValueConverter" />, which uses arbitrary logic for conversion.
    /// </summary>
    public sealed class DelegateConverter : IValueConverter
    {
        /// <summary>
        ///     Creates an object <see cref="DelegateConverter" />.
        /// </summary>
        /// <param name="convert">
        ...
        /// </param>
        public DelegateConverter(Func<object?, object?> convert, Func<object?, object?>? convertBack = null)
        {
