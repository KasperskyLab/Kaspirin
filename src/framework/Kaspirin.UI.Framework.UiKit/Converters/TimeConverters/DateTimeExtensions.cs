...
public static class DateTimeExtensions
{
    ...
    {
        var dateTimeFormatInfo = formatInfo ?? LocalizationManager.FormatCulture.CultureInfo.DateTimeFormat;
        ...
        throw new ArgumentOutOfRangeException(nameof(dateTime), string.Format(CultureInfo.InvariantCulture,
            "Specified DateTime = {0} can't be presented with the current calendar {1} [{2}, {3}].",
            dateTime,
