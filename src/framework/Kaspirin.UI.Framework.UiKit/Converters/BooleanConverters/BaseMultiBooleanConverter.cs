...
public abstract class BaseMultiBooleanConverter<T> : MultiValueConverterMarkupExtension<BaseMultiBooleanConverter<T>>
{
    ...
    /// </param>
    /// <returns>
    ///     Returns <see cref="True" /> if the result of logical operations <see cref="Operation" /> with
    ///     all values <paramref name="values" /> is <see langword="true" />, otherwise <see cref="False" />.
    /// </returns>
