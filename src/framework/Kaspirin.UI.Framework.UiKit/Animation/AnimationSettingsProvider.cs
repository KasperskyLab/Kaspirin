...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="AnimationSettingsProvider" /> class.
    /// </summary>
    /// <param name="winRTUISettings">
    ///     An object that provides settings for the WinRT UI.
    /// </param>
    /// <param name="systemEvents">
    ///     An object that provides system events.
    /// </param>
