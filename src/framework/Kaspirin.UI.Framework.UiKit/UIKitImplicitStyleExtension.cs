...
internal sealed class UIKitImplicitStyleExtension : MarkupExtension
{
    ...
    public SetterBaseCollection NormalAdditionalSetters => _normalAdditionalSetters ??= new();

    public SetterBaseCollection HoverAdditionalSetters => _hoverAdditionalSetters ??= new();

    public SetterBaseCollection PressedAdditionalSetters => _pressedAdditionalSetters ??= new();

    public SetterBaseCollection DisabledAdditionalSetters => _disabledAdditionalSetters ??= new();

    public SetterBaseCollection SelectedNormalAdditionalSetters => _selectedNormalAdditionalSetters ??= new();

    public SetterBaseCollection SelectedHoverAdditionalSetters => _selectedHoverAdditionalSetters ??= new();

    public SetterBaseCollection SelectedPressedAdditionalSetters => _selectedPressedAdditionalSetters ??= new();

    public SetterBaseCollection SelectedDisabledAdditionalSetters => _selectedDisabledAdditionalSetters ??= new();
